...
class MeetColorScreen extends StatefulWidget {
  const MeetColorScreen({super.key});

  @override
  State<MeetColorScreen> createState() => _MeetColorScreenState();
}

class _MeetColorScreenState extends State<MeetColorScreen> {
  @override
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Get.toNamed('/beforeTour');
                    matchedController.getMatchedUser();
                    MatchedModel matchedUser =
                        Get.find<MatchedController>().getMatchedModel();
                    print(matchedUser);
                  },
                  child: Text(
                    'Got it',
